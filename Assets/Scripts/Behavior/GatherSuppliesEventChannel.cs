...
[EventChannelDescription(name: "GatherSuppliesEventChannel", message: "[Self] gathers [Amount] [Supplies] .", category: "Events", id: "06eb00efcc3aa752257ef1df16d24e52")]
public sealed partial class GatherSuppliesEventChannel : EventChannel<GameObject, int, SupplySO>
{
    ...
    public new event GatherSuppliesEventChannelEventHandler Event;

    public new void SendEventMessage(GameObject Self, int Amount, SupplySO Supplies)
    {
